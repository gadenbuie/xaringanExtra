...
You can also set `panelset` to a named vector,
...
Note that when your code contains multiple expressions and outputs,
you may also want to set the `results = "hold"` chunk option.
Currently, knitr chunks default to `results = "markup"`
and each code expression and output pair will generate a pair of tabs.
