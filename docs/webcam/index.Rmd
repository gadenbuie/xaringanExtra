---
title: "webcam<br>.gray[for xaringan]"
pagetitle: "webcam | xaringanExtra"
subtitle: ".big[&#x1F933;]"
...
xaringanExtra::use_webcam(300, 300 / 4 * 3)
```
...
Enable only the **webcam** extension...
...
...or enable a few extensions at once

````markdown
```{r xaringanExtra, include = FALSE}`r ''`
...
Then press .key[w] to turn on the **webcam** — go ahead and try it!

```{css, echo=FALSE}
.gray { color: #999; }
.big { font-size: 200%; }
.red { color: red; }
.mt-big { margin-top: 6em; }
.wide-slide {
  padding-left: 20px;
  padding-right: 20px;
}
...
---
class: left middle wide-slide

## Move the Video Around

Click and drag to move the video around.

--

.right.mt-big[
## Cycle Through the Screen Corners

Press .key[Shift] + .key[W] to move the video to the next corner.

.big[&#x2197;&#xFE0F; &#x2198;&#xFE0F; &#x2199;&#xFE0F; &#x2196;&#xFE0F;]
]

---
background-image: url('yihui.jpg')
...
<div class="the-real-hero">the real hero</div>
